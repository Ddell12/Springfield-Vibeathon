...
export function BuilderHeader({ toolName, shareSlug, onNewTool }: BuilderHeaderProps) {
    ...
    <>
      <header className="h-14 bg-surface-container-lowest sanctuary-shadow flex items-center justify-between px-6 z-10">
        ...
        <div className="flex items-center gap-3">
          <button
            className="hidden lg:flex items-center gap-2 text-primary font-medium text-sm px-4 py-1.5 rounded-lg hover:bg-surface-container-high transition-colors"
            onClick={onNewTool}
          >
          ...
          <button
            className="flex items-center gap-2 px-4 py-1.5 border-2 border-primary/20 text-primary rounded-lg font-bold text-sm hover:bg-primary/5 transition-colors active:scale-95"
