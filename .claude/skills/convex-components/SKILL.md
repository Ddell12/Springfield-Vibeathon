...
description: Reference guide for Convex Components — feature encapsulation with isolated schema and functions. Use when evaluating components vs monolithic code or browsing available sibling components.
---
