---
name: ai-elements
description: Creates components for the ai-elements chat UI library using composable patterns and shadcn/ui. Use only when contributing to the ai-elements package, not for general UI work.
---
